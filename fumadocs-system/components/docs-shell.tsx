...
export function DocsShell({
  ...
  const resolvedSidebarSections = sidebarSections ?? buildSidebarSections(tree, navLabelByUrl);
          ...
          <div className="flex h-(--header-height) items-center gap-4">
            <div className="flex min-w-0 items-center gap-5">
              <Link
                ...
                href={homeHref}
                className="hidden shrink-0 items-center text-sm font-medium lg:inline-flex"
              >
                {brand}
              </Link>
